  ...
  <nav class="navbar has-background-primary">
    <div class="container">
      <div class="navbar-brand">
        <label class="navbar-item logo has-text-white">YOUR DATA</label>
      </div>
      <div class="navbar-menu">
        <ul class="navbar-end">
          ...
          <li class="navbar-item"><a class="navbar-link has-text-white" href="add.php">ADD</a></li>
        </ul>
      </div>
    </div>
  </nav>
...
if (isset($_GET['msg1']) && $_GET['msg1'] === "insert") {
  echo "<div class='notification is-success'>
          ...
          Your have successfully added data. 
        </div>";
}
          ...
          if ($_SESSION['user_name']) {
            ...
            <div class="modal is-active">
              ...
              <div class="modal-content has-text-centered">
                ...
                <a class="button is-primary" href="Signup.php">signup</a>
